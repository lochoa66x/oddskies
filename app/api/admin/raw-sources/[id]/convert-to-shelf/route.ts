...
import {
  convertRawSourceToSignalShelf,
  dryRunRawSourceSignalShelfConversion,
  type CuratedLinkDraftOverrides,
...
export async function POST(
  ...
  try {
    ...
    const result = body.confirm
      ? await convertRawSourceToSignalShelf(id, body.overrides ?? {})
      : await dryRunRawSourceSignalShelfConversion(id, body.overrides ?? {});
