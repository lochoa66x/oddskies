...
- Collector source type does not matter: Bluesky, RSS, Fediverse, YouTube,
  manual inserts, and future collectors all have to pass review before becoming
  public reports.
...
- The same public report filter feeds the homepage atlas/map, Field Log, case
  pages, category pages, and region pages.
